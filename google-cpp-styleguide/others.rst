...
#. 實際上，`預設參數會改變函數簽名的前提是改變了它接收的參數數量 <http://www.zhihu.com/question/24439516/answer/27858964>`_，比如把 ``void a()`` 改成 ``void a(int b = 0)``, 開發者改變其程式碼的初衷也許是，在不改變「程式碼兼容性」的同時，又提供了可選 int 參數的餘地，然而這終究會破壞函數指標上的兼容性，畢竟函數簽名確實變了。
